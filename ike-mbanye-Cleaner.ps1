...
#GUI Variables
$FormTitleText = "Disk Cleaner nke Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "Họrọ diski:"
$FreeSpaceLabelText = "Oghere efu (gigabyte):"
$TotalSpaceLabelText = "Ngụkọta oghere (gigabytes):"
$JunkFoundLabelText = "junk achọtara (gigabyte):"
$CleanDiskBtnText = "Disk dị ọcha *Hichapụ faịlụ*"
$SpaceCleanedLabelText = "Oghere dị ọcha (gigabytes):"
$LogFileLabelText = "Achọtara faịlụ ndekọ: $abcdefg"
$CreditLabelText = "edemede nke Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "ahụrụ faịlụ ndekọ"
$AnalyzingDriveText = "Na-enyocha draịva..."
$BrowsersAreRunningText = "Ihe nchọgharị na-agba ọsọ... Gwa onye ọrụ..."
$PleaseCloseBrowsersText = "Biko mechie ihe nchọgharị weebụ wee nwaa ọzọ."
$CleaningDriveText = "Mbanye na-ehichapụ..."
